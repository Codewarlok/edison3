    ...
    <div class="min-h-screen bg-slate-950 text-slate-100">
      ...
      <main class="max-w-6xl mx-auto px-6 py-16">
        <h1 class="text-5xl font-black leading-tight max-w-3xl">
          Edison: inteligencia de licitaciones para concursar de forma más inteligente.
        </h1>
        <p class="mt-6 text-slate-300 max-w-2xl text-lg">
          Construimos un data warehouse propio de Mercado Público para análisis comercial,
          seguimiento por estado y toma de decisiones orientada a aumentar adjudicaciones.
        </p>
      </main>
    </div>
  );
